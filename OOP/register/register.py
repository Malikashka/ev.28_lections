...
#             user = {'id': id, 'username': username, 'firstname':first_name, 'last_name': last_name, 'password': hashed_password}
#             data.append(user)
#             json.dump(data, file,indent=4)
...
# # print(obj.register('billi', 'billi', 'billi', 'billi123', 'billi123'))
# print((obj_login.login('billi', 'billi123')))
